...
public class RentACatIntegrationTest {
	...
	public void testGetCatNullNumCats0() throws Exception {
		// TODO: Fill in
		RentACat emptyR = RentACat.createInstance(InstanceType.IMPL);
        Method getCatMethod = emptyR.getClass().getDeclaredMethod("getCat", int.class);
        getCatMethod.setAccessible(true);
        Cat cat = (Cat) getCatMethod.invoke(emptyR, 2);
        assertNull(cat);
	...
	public void testRenameFailureNumCats0() {
		// TODO: Fill in
		RentACat emptyR = RentACat.createInstance(InstanceType.IMPL);
        assertFalse(emptyR.renameCat(2, "Garfield"));
        assertEquals("Invalid cat ID." + newline, out.toString());
	}
	...
	public void testReturnFailureCatNumCats3() {
		// TODO: Fill in
		assertFalse(r.returnCat(2)); // Cat is not rented
